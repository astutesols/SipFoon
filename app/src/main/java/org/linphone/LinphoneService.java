...
public final class LinphoneService extends Service {
    ...
    public void onCreate() {
        ...
        //mNotifContentIntent = PendingIntent.getActivity(this, 0, new Intent(), PendingIntent.FLAG_UPDATE_CURRENT);
...
//				}
        ...
        mkeepAlivePendingIntent = PendingIntent.getBroadcast(this, 0, intent, PendingIntent.FLAG_CANCEL_CURRENT);
    ...
    public synchronized void sendNotification(int level, int textId) {
        ...
        if(level == 4){
            mNotifContentIntent = PendingIntent.getActivity(this, 0, new Intent(), PendingIntent.FLAG_CANCEL_CURRENT);
    ...
    private synchronized void notifyWrapper(int id, Notification notification) {
        if (instance != null && notification != null && (mPreferences.getBoolean(Config.PREF_IS_LOGIN_SUCCESS, false))) {
