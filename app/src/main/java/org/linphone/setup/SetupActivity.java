...
import org.linphone.BaseFragmentActivity;
 ...
 */
public class SetupActivity extends BaseFragmentActivity implements OnClickListener {
    ...
    //private SetupViewPagerAdapter mSetupViewPagerAdapter;
...
//        }
        ...
        // Setup main view for viewpager using fragments
//        mViewPager = (ViewPager) findViewById(R.id.viewPager);
//        mSetupViewPagerAdapter = new SetupViewPagerAdapter(SetupActivity.this, getSupportFragmentManager());
//        mViewPager.setAdapter(mSetupViewPagerAdapter);
...
//            tab.setCustomView(mSetupViewPagerAdapter.getTabView(i));
//        }
...
//        }
    ...
    private void display(SetupFragmentsEnum fragment) {
        switch (fragment) {
            ...
            case LINPHONE_LOGIN:
                ...
                break;
            case GENERIC_LOGIN: // Added by aniruddh
                displayLoginGeneric();
                break;
            default:
    ...
    public void displayLoginGeneric() {
        ...
        changeFragment(fragment);
        currentFragment = SetupFragmentsEnum.WELCOME; // Modified by aniruddh
    }
    ...
    public void saveCreatedAccount(String username, String password, String domain) {
        //final ProgressDialog dialog = ProgressDialog.show(SetupActivity.this, "Login", "Please wait...", true);
        //dialog.show();
        if (accountCreated) {
            mPrefs.deleteAccount(mPrefs.getAccountCount() - 1);
            //return;
        }
        ...
        try {
            ...
            //dialog.dismiss();
            Toast.makeText(SetupActivity.this, "Please Enter valid SIP domain.", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
