...
//    }
    ...
    LinearLayout incomingChatBubble;
    float scale;

    @SuppressLint("InflateParams")
    public BubbleChat(final Context context, float scale, LinphoneChatMessage message, LinphoneChatMessage.LinphoneChatMessageListener listener) {
        if (message == null) {
            return;
        }
...
//    		view.setBackgroundResource(R.drawable.balloon_outgoing_mask);
//			view.setBackgroundTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.contact_delete_button_background_color)));
        } else {
            layoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
//    		view.setBackgroundResource(R.drawable.balloon_incoming_top);
        }
...
//    	layoutParams.setMargins(10, 0, 10, 0);
        ...
        if (context.getResources().getBoolean(R.bool.display_time_aside)) {
            ...
            if (message.isOutgoing()) {
                ...
                setMargins(view, (int) (84 * scale), 0, 0, 0);
                incomingChatBubble = (LinearLayout) layout.findViewById(R.id.incomingChatBubble);
            }
        }
