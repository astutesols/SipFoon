 ...
 */
public class IncomingCallActivity extends BaseActivity implements LinphoneSliderTriggered {
    ...
    private ImageView answerCall, declineCall;
...
//        mIncomingCallWidget.setOnTriggerListener(this);
        ...
        answerCall = (ImageView) findViewById(R.id.answer_call);
        ...
        declineCall = (ImageView) findViewById(R.id.decline_call);
    ...
    protected void onResume() {
        ...
        LinphoneUtils.setImagePictureFromUri(this, mPictureView.getView(), contact != null ? contact.getPhotoUri() : null,
                contact != null ? contact.getThumbnailUri() : null, R.drawable.new_unknown_small);
        ...
        if (contact != null && contact.getID() != null) {
            ...
            if (nameCursor != null && nameCursor.getCount() > 0) {
                while (nameCursor.moveToNext()) {
                    mNumberView.setText(nameCursor.getString(nameCursor.getColumnIndex(ContactsContract.Data.DISPLAY_NAME)));
                }
            }
            ...
            if (getResources().getBoolean(R.bool.only_display_username_if_unknown)) {
                mNumberView.setText(address.getUserName());//contact != null ? contact.getName() : address.getUserName()
                android.util.Log.e("CONTACT", "Contact first condition:" + address.getUserName());
            } else {
        ...
        //Log.e("Incoming name: " + contact.getID() + " : " + address.getUserName());
    }
