 ...
 */
public class InCallActivity extends BaseFragmentActivity implements OnClickListener {
    ...
    private TextView conference;//options,
    private TextView speaker, micro, video , pause, hangUp ,addCall, transfer, alternate_dialer, alternate_hangUp, alternate_pause;
    private TextView audioRoute, routeReceiver, dialer;//routeSpeaker,routeBluetooth
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPreferences = PreferenceManager.getDefaultSharedPreferences(InCallActivity.this);
...
//        		}
    ...
    private void initUI() {
        ...
        video.setEnabled(false);
//        if (!mPreferences.getBoolean(Config.PREF_VIDEO_ENABLED, false)) {
...
//		options.setEnabled(false);
        ...
        alternate_dialer = (TextView) findViewById(R.id.alternate_dialer);
        alternate_dialer.setOnClickListener(this);

        alternate_hangUp = (TextView) findViewById(R.id.alternate_hangUp);
        alternate_hangUp.setOnClickListener(this);

        alternate_pause = (TextView) findViewById(R.id.alternate_pause);
        alternate_pause.setOnClickListener(this);
...
//                    routeLayout.setVisibility(View.GONE);
    ...
    private void refreshInCallActions() {
        ...
        if (!LinphonePreferences.instance().isVideoEnabled()) {
            ...
            if (isVideoEnabled(LinphoneManager.getLc().getCurrentCall())) {
                video.setBackgroundResource(R.drawable.video_on_default);

                hangUp.setBackgroundResource(R.drawable.ic_decline_call);

//                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams( LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);//
////                lp.addRule(RelativeLayout.ALIGN_PARENT_TOP);
//                lp.gravity = Gravity.CENTER_HORIZONTAL;
//                //lp.addRule(RelativeLayout.ALIGN_TOP, R.id.pause);
////                lp.bottomMargin = 10;
////                lp.topMargin = 10;
////                lp.width = pause.getWidth();
////                lp.height = pause.getHeight();
//                hangUp.setLayoutParams(lp);

            } else {
                video.setBackgroundResource(R.drawable.video_off_default);
...
//                hangUp.setLayoutParams(lp);
        ...
        try {
            if (isSpeakerEnabled) {
                speaker.setBackgroundResource(R.drawable.speaker_on_default);
...
//				routeBluetooth.setBackgroundResource(R.drawable.route_bluetooth_off);
                ...
                speaker.setBackgroundResource(R.drawable.speaker_off_default);
...
//        if (isMicMuted) {
//            micro.setBackgroundResource(R.drawable.micro_on_default);
//        } else {
//            micro.setBackgroundResource(R.drawable.micro_off_default);
//        }
        ...
        if (LinphoneManager.getLc().getCallsNb() > 1) {
            ...
            if (pausedCalls.size() == 1) {
                ...
                pause.setBackgroundResource(R.drawable.pause_on_default);
            }
        }
    }
...
//		status = statusFragment;
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.video) {
            ...
            Log.e("isConferenceRunning","isConferenceRunning:"+isConferenceRunning);
            ...
            hangUp();
        } else if (id == R.id.alternate_hangUp) {
            hangUp();
        } else if (id == R.id.alternate_dialer) {
            hideOrDisplayNumpad();
        } else if (id == R.id.alternate_pause) {
//            alternate_dialer.setVisibility(View.GONE);
//            alternate_hangUp.setVisibility(View.GONE);
//            alternate_pause.setVisibility(View.GONE);
            callsList.setVisibility(View.GONE);
            pauseOrResumeCall();
...
//                @Override
//                public void run() {
//                    alternate_dialer.setVisibility(View.VISIBLE);
//                    alternate_pause.setVisibility(View.VISIBLE);
//                    alternate_hangUp.setVisibility(View.VISIBLE);
//                }
//            }, 4000);
...
//								options.setBackgroundResource(R.drawable.options);
    ...
    private void hideNumpad() {
        ...
        alternate_dialer.setBackgroundResource(R.drawable.dialer_alt);
        if (isAnimationDisabled) {
            numpad.setVisibility(View.GONE);
        } else {
            Animation animation = slideOutTopToBottom;
    ...
    private void hideOrDisplayNumpad() {
        ...
        if (numpad.getVisibility() == View.VISIBLE) {
            ...
            alternate_dialer.setBackgroundResource(R.drawable.dialer_alt_back);
            if (isAnimationDisabled) {
...
//
//        conferenceState = (ImageView) conferenceHeader.findViewById(R.id.conferenceStatus);
//        conferenceState.setOnClickListener(this);
    ...
    private void displayCall(Resources resources, LinphoneCall call, int index) {
        ...
        Log.e("Incall activity name", call.getRemoteAddress().getDisplayName());
        // Image Row 
        RelativeLayout imageView = (RelativeLayout) inflater.inflate(R.layout.active_call_image_row, container, false);
        ...
        setContactName(call.getRemoteAddress().getDisplayName(),callView, lAddress, sipUri, resources);
...
//                        imageView.setVisibility(View.VISIBLE);
    ...
    private void setContactName(String name,LinearLayout callView, LinphoneAddress lAddress, String sipUri, Resources resources) {
        ...
        if (lContact == null) {
            android.util.Log.e("CONTACT","Contact null");
            if (resources.getBoolean(R.bool.only_display_username_if_unknown) && LinphoneUtils.isSipAddress(sipUri)) {
                ...
                android.util.Log.e("CONTACT", "Contact first condition:"+lAddress.getUserName());
            } else {
                contact.setText(sipUri);
                android.util.Log.e("CONTACT", "Contact second condition:"+sipUri);
            }
        } else {
            android.util.Log.e("CONTACT", "Contact third condition name:" + name);
            if(name != null){
                contact.setText(name);
            }else {
                contact.setText(lContact.getName());
            }
            android.util.Log.e("CONTACT", "Contact third condition getName:" + lContact.getName());
        }
    }
    ...
    private void displayOrHideContactPicture(RelativeLayout callView, Uri pictureUri, Uri thumbnailUri, boolean hide) {
        AvatarWithShadow contactPicture = (AvatarWithShadow) callView.findViewById(R.id.contactPicture);
        if (pictureUri != null) {
            LinphoneUtils.setImagePictureFromUri(callView.getContext(), contactPicture.getView(), Uri.parse(pictureUri.toString()), thumbnailUri, R.drawable.new_unknown_small);
        }
