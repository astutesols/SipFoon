...
public class SettingsFragment extends PreferencesListFragment {
    ...
    private void initSettings() {
        ...
        findPreference(getString(R.string.pref_exit_key)).setOnPreferenceClickListener(new OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                if (LinphoneActivity.isInstanciated()) {
//                    LinphoneActivity.instance().moveTaskToBack(true);

                    Toast.makeText(getActivity(), "Exiting application", Toast.LENGTH_LONG).show();
                    mHandler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            LinphoneService.instance().killService();
        ...
        findPreference(getString(R.string.pref_logout_exit_key)).setOnPreferenceClickListener(new OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                if (LinphoneActivity.isInstanciated()) {
                    LinphonePreferences.instance().logoutAndExitUser(getActivity());
                    return true;
                }
                return false;
            }
    ...
    private void hideSettings() {
        ...
        hidePreference(R.string.pref_sipinfo_dtmf_key);
        hidePreference(R.string.pref_rfc2833_dtmf_key);
        hidePreference(R.string.pref_voice_mail_key);
        hidePreference(R.string.pref_call_settings_key);
